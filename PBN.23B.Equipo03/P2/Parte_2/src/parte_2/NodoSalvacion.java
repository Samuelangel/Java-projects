...
public class NodoSalvacion {// Declaración de variables miembro públicas
    ...
    public NodoSalvacion siguiente;// Referencia al siguiente nodo en la lista

    public NodoSalvacion(String CODOP, String Operando, String AddrMode, String SourceForm, String byteCalcular, String byteTotal, NodoSalvacion siguiente) {// Inicialización de variables miembro con los valores proporcionados
        this.CODOP = CODOP;
        ...
        this.siguiente = siguiente;// Referencia al siguiente nodo en la lista
    }
